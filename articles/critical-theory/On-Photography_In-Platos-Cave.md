...
As we may recall, [Plato’s Cave]({{ '/glossary/platos-cave/' | url }}) describes humans as though they are prisoners in a cave, where all they can see are shadows cast onto a wall. It is the job of the philosopher to leave the cave in order to see the world as it really is. With her title, Sontag implies that the photographs with which we are surrounded in our everyday lives are like the shadows on the wall of the cave. To think of photographs as little pieces of reality is to make a grave mistake.
